...
public static class BackgroundJobs
{
    ...
    public static void Startup()
    {
        RecurringJob.AddOrUpdate(
            ...
            () => MaintenanceJobAsync(),
            Cron.Daily(7));
        RecurringJob.TriggerJob(MaintenanceJobId);
    ...
    public static void ResetSettingsBiasedJobs()
    {
        RecurringJob.AddOrUpdate(
            ...
            Cron.Hourly(),
            TimeZoneInfo.Local);
        RecurringJob.TriggerJob(MoveFileJobId);
    }
    ...
    public static async Task MoveFilesAsync()
    {
        ...
        {
            Logging?.AddLog($"No source location set, no videos moved at {DateTime.Now:yyyy-MM-ddTHH:mm:ss}");
            return;
        }
